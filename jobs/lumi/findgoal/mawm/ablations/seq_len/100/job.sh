...
srun torchrun --standalone --nnodes=1 --nproc_per_node=4 train_wm.py --config ../cfgs/findgoal/mawm/ablations/seq_len/mawm_seq_100.yaml --env_file ../.env --timestamp ${ts}
