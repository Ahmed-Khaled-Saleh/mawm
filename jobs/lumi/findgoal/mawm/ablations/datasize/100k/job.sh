...
srun torchrun --standalone --nnodes=1 --nproc_per_node=2 train_wm.py --config ../cfgs/findgoal/mawm/ablations/datasize/mawm_ds_100k.yaml --env_file ../.env --timestamp ${ts}
