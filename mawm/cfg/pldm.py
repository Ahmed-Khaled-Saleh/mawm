...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/07b_logger.ipynb.

# %% auto 0
__all__ = ['DataClass', 'DataClassType', 'DataclassArgParser', 'omegaconf_parse', 'omegaconf_parse_files_vals',
           'combine_cli_dict', 'combine_dataclass_dict', 'ConfigBase']

# %% ../../nbs/07b_logger.ipynb 3
import argparse
import dataclasses
