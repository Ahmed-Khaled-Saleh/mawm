...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/08_writers.wandb_writer.ipynb.

# %% auto 0
__all__ = ['WandbWriter']

# %% ../../nbs/08_writers.wandb_writer.ipynb 3
...
# %% ../../nbs/08_writers.wandb_writer.ipynb 4
class WandbWriter:
...
# %% ../../nbs/08_writers.wandb_writer.ipynb 5
@patch
