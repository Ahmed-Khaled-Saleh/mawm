...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/02f_models.dynamics.predictor.ipynb.

# %% auto 0
__all__ = ['ConvPredictorConfig', 'RNNPredictor', 'RNNPredictorV3', 'RNNPredictorBurnin', 'RSSMPredictor', 'SequencePredictor',
           'MLPPredictor', 'RNNPredictorV2', 'ConvPredictor']

# %% ../../../nbs/02f_models.dynamics.predictor.ipynb 3
from fastcore import *
from fastcore.utils import *

# %% ../../../nbs/02f_models.dynamics.predictor.ipynb 4
import torch
import torch.nn as nn

# %% ../../../nbs/02f_models.dynamics.predictor.ipynb 5
...
# from mawm.models import dynamics as models
from ..utils import *
...
def forward_multiple(
    ...
    if self.pred_pos_dim:
        if isinstance(self.pred_pos_dim, int):
            ...
            propio_component = state_predictions[:, :, -self.pred_pos_dim :]
        else:
            pred_propio_channels = self.pred_pos_dim[0]
            obs_component = state_predictions[:, :, :-pred_propio_channels]
            propio_component = state_predictions[:, :, -pred_propio_channels:]
    else:
        obs_component = state_predictions
