...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02i_models.hjepa.ipynb.

# %% auto 0
__all__ = ['HJEPAConfig', 'ForwardResult', 'HJEPA']

# %% ../../nbs/02i_models.hjepa.ipynb 3
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/02i_models.hjepa.ipynb 4
...
import operator
from .vision import build_backbone, build_conv, BackboneConfig, BackboneOutput
from .dynamics import build_predictor
...
from .jepa import JEPA, JEPAConfig, ForwardResult as JEPAForwardResult
...
# %% ../../nbs/02i_models.hjepa.ipynb 7
@patch
def update_ema(self: HJEPA):
