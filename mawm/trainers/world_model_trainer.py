...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/05b_trainers_world_model_trainer.ipynb.

# %% auto 0
__all__ = ['WMTrainer']

# %% ../../nbs/05b_trainers_world_model_trainer.ipynb 3
...
# %% ../../nbs/05b_trainers_world_model_trainer.ipynb 4
...
class WMTrainer(Trainer):
    def __init__(self, cfg, model, train_loader, val_loader=None, 
        ...
        self.vae_dir = os.path.join(self.cfg.log_dir, 'world_model')
...
# %% ../../nbs/05b_trainers_world_model_trainer.ipynb 5
@patch
...
# %% ../../nbs/05b_trainers_world_model_trainer.ipynb 7
@patch
...
# %% ../../nbs/05b_trainers_world_model_trainer.ipynb 8
@patch
...
# %% ../../nbs/05b_trainers_world_model_trainer.ipynb 9
import wandb
