...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/05b_trainers_programJepa.ipynb.

# %% auto 0
__all__ = ['WMTrainer']

# %% ../../nbs/05b_trainers_programJepa.ipynb 3
...
# %% ../../nbs/05b_trainers_programJepa.ipynb 4
from .trainer import Trainer
from ..models.utils import save_checkpoint

class WMTrainer(Trainer):
    def __init__(self, cfg, pencoder, predictor, train_loader, val_loader=None, 
        ...
        super().__init__(cfg, pencoder, train_loader, val_loader, criterion, optimizer, device)
        ...
        self.pjepa_dir = os.path.join(self.cfg.log_dir, 'pjepa')
        if not os.path.exists(self.pjepa_dir):
            os.mkdir(self.pjepa_dir)
            os.mkdir(os.path.join(self.pjepa_dir, 'samples'))
    

# %% ../../nbs/05b_trainers_programJepa.ipynb 5
@patch
def reload(self: WMTrainer):
...
# %% ../../nbs/05b_trainers_programJepa.ipynb 7
@patch
...
# %% ../../nbs/05b_trainers_programJepa.ipynb 8
@patch
...
# %% ../../nbs/05b_trainers_programJepa.ipynb 9
import wandb
