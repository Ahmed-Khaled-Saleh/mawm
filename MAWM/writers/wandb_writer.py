...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/08_wandb_writer.ipynb.

# %% auto 0
__all__ = ['WandbWriter']

# %% ../../nbs/08_wandb_writer.ipynb 3
...
# %% ../../nbs/08_wandb_writer.ipynb 5
@patch
def write(self: WandbWriter, log_dict):
    wandb.log(log_dict)

# %% ../../nbs/08_wandb_writer.ipynb 7
@patch
