...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02e_models_dense.ipynb.

# %% auto 0
__all__ = ['DenseModel']

# %% ../../nbs/02e_models_dense.ipynb 3
import numpy as np
import torch
