...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/03f_models.synthesizer.ipynb.

# %% auto 0
__all__ = ['ProgramSynthesizer', 'ModelConfig', 'RotaryPositionEmbedding', 'RMSNorm', 'SelfAttention', 'FeedForward',
           'EncoderBlock', 'Transformer']

# %% ../../nbs/03f_models.synthesizer.ipynb 2
from fastcore import *
from fastcore.utils import *

# %% ../../nbs/03f_models.synthesizer.ipynb 3
import torch
...
class ProgramSynthesizer(nn.Module):
    ...
    def __init__(
        ...
        self.syhn_mlp = DenseModel(output_shape= (model_info['node_size'],), input_size=model_info['node_size'], info= model_info)

        # heads
        self.prim_head = nn.Linear(model_info['node_size'], num_prims)
...
# %% ../../nbs/03f_models.synthesizer.ipynb 18
import torch
import torch.nn as nn
import torch.nn.functional as F
import math
...
# %% ../../nbs/03f_models.synthesizer.ipynb 19
...
# %% ../../nbs/03f_models.synthesizer.ipynb 20
...
# %% ../../nbs/03f_models.synthesizer.ipynb 21
...
# %% ../../nbs/03f_models.synthesizer.ipynb 22
...
# %% ../../nbs/03f_models.synthesizer.ipynb 23
...
# %% ../../nbs/03f_models.synthesizer.ipynb 24
