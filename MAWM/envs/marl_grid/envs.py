...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/07h_envs.marlgrid_envs.ipynb.

# %% auto 0
__all__ = ['this_module', 'make_agents', 'get_env_creator', 'get_env_class_creator', 'register_env', 'env_from_config']

# %% ../../../nbs/07h_envs.marlgrid_envs.ipynb 3
from fastcore import *
from fastcore.utils import *

# %% ../../../nbs/07h_envs.marlgrid_envs.ipynb 4
import inspect
import numpy.random as random
import sys
from gymnasium.envs.registration import register as gym_register

from .envs.findgoal import FindGoalMultiGrid
from .envs.redbluedoors import RedBlueDoorsMultiGrid
...
# %% ../../../nbs/07h_envs.marlgrid_envs.ipynb 5
def make_agents(
        n_agents,
        view_size,
        view_tile_size=8,
...
# %% ../../../nbs/07h_envs.marlgrid_envs.ipynb 6
def get_env_creator(
        env_class,
        n_agents,
        grid_size,
...
# %% ../../../nbs/07h_envs.marlgrid_envs.ipynb 7
...
# %% ../../../nbs/07h_envs.marlgrid_envs.ipynb 8
def register_env(
        env_name,
        n_agents,
        grid_size,
...
# %% ../../../nbs/07h_envs.marlgrid_envs.ipynb 9
